...
[![My Skills](https://skillicons.dev/icons?i=react,astro,vue,nextjs,remix,electron,fastapi,redux,js,ts,nestjs,vite,nodejs,express,prisma,jest,go,py,html,css,tailwind,materialui,cs,git,github,unity,vercel,gcp,aws,firebase,postgresql,mysql,docker)](https://skillicons.dev)
